...
public class GraphToolBox {
  ...
  // Function to create and verify a powerset
  static void printPowerSet(int[] set, int n, Graph inputGraph)
  {
    ...
    for (int i = 0; i < n; i++) {
      ...
      do {
        ...
        if (vcVerifier(powSet, inputGraph)) { //run generated set through a polynomial Vertex Cover verifier
  ...
  public static int[] exactVC(Graph inputGraph) {
    ...
    public static boolean vcVerifier(HashSet<Integer> set, Graph inputGraph) {
